<%@ Page Title="" Language="C#" MasterPageFile="~/Restaurant/Restaurant.Master" AutoEventWireup="true" CodeBehind="MenuDetail.aspx.cs" Inherits="WebCommerce.Restaurant.MenuDetail" %>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body" style="margin-left: 30px">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="txtUsername">ราคาอาหาร [S] </label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="txtUsername">ราคาอาหาร [M] </label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="txtUsername">ราคาอาหาร [L] </label>
